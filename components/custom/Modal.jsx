...
const Modal = ({ title, children, isOpen, onClose, onAction, actionLabel }) => {
  ...
  return (
    <div className="fixed left-0 top-0 z-[80] flex h-full w-full items-center justify-center bg-[#13131a] bg-opacity-90">
      <div className="relative w-11/12 rounded-xl border border-gray-200 bg-white shadow-sm md:w-1/2 lg:w-2/3 dark:border-neutral-800 dark:bg-[#13131a]">
        <div className="p-4 sm:p-7">
          ...
          <div className="mt-4 flex justify-end space-x-2">
            <Button
              onClick={onAction}
              className="inline-flex w-full items-center justify-center gap-x-2 rounded-lg border border-transparen px-4 py-2 text-sm font-semibold text-white disabled:pointer-events-none disabled:opacity-50"
            >
              {actionLabel}
            </Button>
          </div>
